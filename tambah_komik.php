...
<body>
    ...
    <div class="container">
        ...
        ?>
        <h3 style="color:red;">Peringatan!, ini hanya upload foto komik saja</h3>
        <form action="simpan.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <a href="tambah_episode.php" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Episode Komik</a>
        </form>

        <hr>
        <h3>jika ingin isi data komik , edit data di bawah ini dengan klik icon pensil</h3>
        <div class="row">
            <div class="col-sm-6">
                <div class="table-responsive">
                    <table class="table table-bordered" width='20%'cellspacing="0">
                        ...
                        <?php
                            ...
                            $sql="select * from tb_komik order by id_komik desc";
                        ...
                        <tr>
                            <td><?php echo $no; ?></td>
                            <td><img src="image/komik/<?php echo $data['gambar'];?>" class="rounded" width='100%' alt="GAMBAR KOMIK BUKAN EPISODE KOMIK"></td>
                            <td><?php echo $data['nama_komik'];?></td>
                            <td><?php echo $data['ket'];?></td>
                            <td><?php echo $data['tanggal_upload'];?></td>
                            <td><a href="edit_komik.php?id=<?php echo $data['id_komik'] ?>" class="btn btn-success"><i class="fa fa-pencil"></i></td>
                        </tr>
